 ...
 */
class DisableAutocomplete extends Frontend {

		/**
		 * load form field and check autocompleteoff
		...
		public function loadFormField(Widget $objWidget, $strForm, $arrForm) {
				...
				if(WidgetAutocomplete::getAutocompleteOff($objWidget))
					WidgetAutocomplete::setAutocomplete($objWidget, false);
